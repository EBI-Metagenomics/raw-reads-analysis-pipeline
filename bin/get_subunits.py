...
LSU_filename = directory + "/LSU_hits.fasta"
SSU_filename = directory + "/SSU_hits.fasta"
FiveS_filename = directory + "/5S_hits.fa"
FiveEightS_filename = directory + "/5_8S_hits.fa"
